 ...
 *
 * When the GeoTIFF source has a nodata value, OpenLayers adds an alpha band
 * (band 2): 0 for NODATA/padding pixels, 255 for valid data. The custom `color`
 * expression fully replaces the pixel output, so we must check band 2 explicitly.
 */
const cloudsRainWebGLStyle = {
  color: [
    ...
    ['==', ['band', 2], 0],
    [0, 0, 0, 0],
    // Cloud cover color ramp (band value 0–100)
    ['<', ['band', 1], 5],
    [0, 0, 0, 0],
    ['<', ['band', 1], 20],
    [255, 255, 255, 1],
